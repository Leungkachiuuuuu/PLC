...
data Json = Brackets [Pair] {- define yourself -}
  deriving (Show, Eq)
...
ez7 = Brackets [("z", Array [Str "Days", Str "Nights", Array [Str "Morning", Str "Afternoon"]]),("a", Str "Easy"),("b", Array [Val 12, Val 13, Val 14])]
